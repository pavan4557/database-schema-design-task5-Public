...
-- =============================
-- Task 5: Joins (MySQL safe version)
-- =============================
...
-- Joining 3 tables example: Loans with Member name and Book category
